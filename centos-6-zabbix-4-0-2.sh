...
mysql -h'127.0.0.1' -u'zabbix' -p'zabbix' -P'3306' zabbix < ./zabbix-4.0.2/database/mysql/images.sql 
mysql -h'127.0.0.1' -u'zabbix' -p'zabbix' -P'3306' zabbix < ./zabbix-4.0.2/database/mysql/data.sql 
...
cp -ar ${Path}/zabbix-4.0.2/frontends/php/* /var/www/html/zabbix/
...
cp -a ${Path}/zabbix-4.0.2/misc/init.d/fedora/core/zabbix_* /etc/init.d/
