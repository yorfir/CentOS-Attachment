...
if [[ $PHP_VER_ID == 2 ]]; then
    PHP_VER="5.6.15"
    ext_dir="no-debug-non-zts-20131226"
else
    PHP_VER="5.2.17"
...
###
cd /tmp
wget -c http://dl.wdlinux.cn:5180/soft/libevent-2.0.22-stable.tar.gz
wget -c http://dl.wdlinux.cn:5180/soft/memcached-1.4.25.tar.gz
